...
public @Configuration class RabbitMQConfig {

  public static final String TOPIC_EXCHANGE_NAME = "picpay-exchange";
  public static final String QUEUE_NAME = "picpay-queue";
  private static final String ROUTING_KEY = "querysearchusers.#";
